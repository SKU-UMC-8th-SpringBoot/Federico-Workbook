...
public class QMember extends EntityPathBase<Member> {
    ...
    private static final long serialVersionUID = -1063075592L;
    ...
    public final EnumPath<week6.domain.enums.Gender> gender = createEnum("gender", week6.domain.enums.Gender.class);
    ...
    public final EnumPath<week6.domain.enums.SocialType> socialType = createEnum("socialType", week6.domain.enums.SocialType.class);

    public final StringPath specAddress = createString("specAddress");

    public final EnumPath<week6.domain.enums.MemberStatus> status = createEnum("status", week6.domain.enums.MemberStatus.class);
